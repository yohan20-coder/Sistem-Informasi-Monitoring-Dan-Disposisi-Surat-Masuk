...
class Bidangii extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->model('Bagianii_model','jml');
    ...
    $this->load->view('bidangii/index',$data);
  ...
  public function masuk()
  {
    ...
    $data['tampil'] = $this->tmp->statuskii();
    ...
    $this->load->view('template/sidebar',$data);
    $this->load->view('template/topbar',$data);
    $this->load->view('bidangii/masuk',$data);
    $this->load->view('template/footer');
  }
  ...
  public function detail($id)
  {
    ...
    $this->load->view('template/sidebar',$data);
    $this->load->view('template/topbar',$data);
    $this->load->view('bidangii/detail',$data);
    $this->load->view('template/footer');
    ...
    $this->db->update('tb_statuskii', $data);
