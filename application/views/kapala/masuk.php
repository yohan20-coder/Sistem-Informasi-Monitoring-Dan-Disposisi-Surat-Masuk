          ...
          <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <?php if($sm['status_kap']==0) { ?>
                              <a href="<?= base_url();?>kapala/detail/<?= $sm['id'] ?>" class="btn btn-success btn-sm">Baca</a>
                          <?php }else{ ?>
                            <a href="<?= base_url();?>kapala/det/<?= $sm['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                          <?php } ?>
                          </td>
                      </tr>
                  <?php $no++ ?>
