 ...
 <!-- Basic Card Example -->
          ...
          <div class="row">
            <div class="col-md-12">
              <?= $this->session->flashdata('message'); ?>
                ...
                <!-- <div class="row">
                    <div class="col-md-12"> -->
                    <form action="<?= base_url();?>kapala/detail/<?= $detail['id'] ?>" method="post">
                        ...
                        <div class="card shadow">
                            ...
                            <table class="table"  width="100%" cellspacing="0">
                                    ...
                                    <!-- <tr>
                                        ...
                                        <input type="hidden" class="form-control" name="catatan" value="<?= $detail['catatan'];?>" readonly>
                                    </tr> -->
                            </table>
    ...
    <div class="card shadow">
                                <div class="card-header bg-info text-white col-md-12">
                                   Balas Pesan Ke Sekertaris
                                </div>
                                <div class="card-body">

                                <div class="form-group row">
                                    <label for=""> <strong>Ditujukan Kepada : Sekertaris Bappeda</strong></label>
                                </div>

                                <!-- <div class="form-check row ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis" value="Sekertaris Bappeda" required>
                                            <label for="nip">Sekertaris Bappeda</label>
                                </div> -->
                               
                                <div class="form-group row">
                                            <label for="ringkas"><strong>Catatan</strong></label>
                                            <textarea class="form-control" name="ringkas" rows="6" required><?= $detail['balas'];?></textarea>
