 ...
 <!-- Basic Card Example -->
          ...
          <div class="row">
            <div class="col-md-12">
              <?= $this->session->flashdata('message'); ?>
                ...
                <!-- <div class="row">
                    <div class="col-md-12"> -->
                    <form action="<?= base_url();?>kapala/edit/<?= $detail['id'] ?>" method="post">
                        ...
                        <div class="card shadow">
                            ...
                            <table class="table"  width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>Catatan</td>
                                        <td>: <?= $detail['cat_sek'] ?></td>
                                        <input type="hidden" class="form-control" name="catatan" value="<?= $detail['cat_sek'];?>" readonly>
                                    </tr>
                            </table>
    ...
    <div class="card shadow">
                                ...
                                <div class="form-check row ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis" value="Sekertaris Bappeda" <?php if($detail['ditujukan']=='Sekertaris Bappeda'){echo "checked";} ?> required>
