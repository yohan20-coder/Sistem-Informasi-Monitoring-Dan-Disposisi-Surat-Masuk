                    ...
                    <form action="<?= base_url();?>sekertaris/edit/<?= $detail['id'] ?>" method="post">
                        ...
                        <div class="card shadow">
                                ...
                                <div class="form-check row ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis1" value="Kapala Bappeda" <?php if($detail['ditujukan1']=='Kapala Bappeda'){echo "checked";} ?>>
                                            <label for="nip">Kapala Bappeda</label>
                                </div>
                                <div class="form-check row  ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis2" value="Kapala Bidang PP I" <?php if($detail['ditujukan']=='Kapala Bidang PP I'){echo "checked";} ?>>
                                            <label for="nip">Kapala Bidang PP I</label>
                                </div>
                                <div class="form-check row  ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis3" value="Kapala Bidang PP II" <?php if($detail['ditujukan2']=='Kapala Bidang PP II'){echo "checked";} ?>>
                                            <label for="nip">Kapala Bidang PP II</label>
                                </div>
                                <div class="form-check row  ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis4" value="Kapala Bidang PP III" <?php if($detail['ditujukan3']=='Kapala Bidang PP III'){echo "checked";} ?>>
                                            <label for="nip">Kapala Bidang PP III</label>
                                </div>
                                <div class="form-check row  ml-2">
                                            <input class="form-check-input" type="checkbox" name="dis5" value="Kapala Bidang PP IV" <?php if($detail['ditujukan4']=='Kapala Bidang PP IV'){echo "checked";} ?>>
