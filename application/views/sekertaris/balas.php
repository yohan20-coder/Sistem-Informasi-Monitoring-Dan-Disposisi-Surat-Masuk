          ...
          <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <?php if($sm['stat_balas']==0) { ?>
                          <td style ="background-color : #fcfc7583; color:black">
                          <b>Balasan Surat : Kapala Bappeda</b><br>
                          ...
                          <td class="text-center">
                            <?php if($sm['stat_balas']==0) { ?>
                              <a href="<?= base_url();?>sekertaris/dett/<?= $sm['id'] ?>" class="btn btn-success btn-sm">Baca</a>
                            <?php }else{ ?>
                              <a href="<?= base_url();?>sekertaris/editt/<?= $sm['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                          </td>
                          <?php } ?>
                      </tr>
                  <?php $no++ ?>
