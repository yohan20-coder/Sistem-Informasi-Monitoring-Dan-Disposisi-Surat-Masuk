        ...
        <div class="container-fluid">
          ...
          <h6 class="text-center text-warning"><strong>Selamat Datang Di Dashboard Sistem Status Anda <br> Adalah : Peanggenda Surat Masuk</strong></h6><br>
  ...
  <div class="card border-left-danger shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Agenda Surat Masuk Belum Dibaca Sekertaris Bappeda</div>
...
<div class="col-xl-3 col-md-6 mb-4">
  <div class="card border-left-warning shadow h-100 py-2">
    <div class="card-body">
      <div class="row no-gutters align-items-center">
        <div class="col mr-2">
          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Agenda Surat Masuk Sudah Dibaca Sekertaris Bappeda</div>
